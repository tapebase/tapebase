...
const artistFields = "id,name,slug,spotify_id,image_url,description,country_code,catalog_visible,real_name,birth_date,birth_date_precision,birth_place,enrichment_source,enrichment_source_id,enrichment_source_url";
