...
export default function PrivacyPage() {
  return <InfoPage eyebrow="Informacje" title="Polityka prywatności" intro="Opis danych używanych przez testową wersję TAPEBASE. Ostatnia aktualizacja: 11 września 2026 r.">
