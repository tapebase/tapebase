  ...
  return <main>
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
      <div className="rounded-3xl bg-white p-5 shadow-sm sm:p-8">
        <h1 className="max-w-3xl text-4xl font-black tracking-tight sm:text-5xl">Oceniaj, dodawaj i odkrywaj albumy oraz artystów. Twórz własny i globalny ranking.</h1>
